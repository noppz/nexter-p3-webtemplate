<template>
  <v-app>
    ...
    <v-app-bar hide-on-scroll :clipped-left="clipped" elevation="1" dark dense fixed app>
    ...
    <v-navigation-drawer v-model="rightDrawer" :right="right" :width="drawerSize" temporary fixed>
      <v-list>
