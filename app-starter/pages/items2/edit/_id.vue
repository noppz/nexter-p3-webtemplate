          ...
          <material-card color="blue">
            ...
            <v-container>
              <v-row dense justify="center">
                ...
                <v-col cols="12" md="8">
                  <v-text-field v-model="editedItem.calories" label="Calories" dense />
                </v-col>
                <v-col cols="12" md="8">
                  <v-text-field v-model="editedItem.fat" label="Fat (g)" dense />
                </v-col>
                <v-col cols="12" md="8">
                  <v-text-field v-model="editedItem.carbs" label="Carbs (g)" dense />
                </v-col>
                <v-col cols="12" md="8">
                  <v-text-field v-model="editedItem.protein" label="Protein (g)" dense />
                </v-col>
                <v-col cols="12" md="8">
                  <div class="text-center">
                    ...
                    <v-btn color="error" rounded style="width: 6rem;" class="mx-1" @click="remove">
                      Delete
                    </v-btn>
